...
export async function init()  {
    if (game.settings.get(MODULE_ID, CLIENT_KEY)) {
        if (CONFIG.Combat.fallbackTurnMarker === 'modules/iron-codex/artwork/fm-turnmarker-disposition.png') {
            CONFIG.Combat.fallbackTurnMarker = 'icons/vtt-512.png'
        } else {
            CONFIG.Combat.fallbackTurnMarker = 'modules/iron-codex/artwork/fm-turnmarker-disposition.png'
